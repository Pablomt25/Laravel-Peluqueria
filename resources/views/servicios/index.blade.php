                ...
                <table class="mx-auto min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <tbody class="text-gray-700">
                        @foreach ($servicios as $servicio)
                            <tr>
                                <td class="text-center py-3 px-4 border-b border-gray-600">{{ $servicio->nombre }}</td>
                                {{-- <td class="py-3 px-4 border-b border-gray-600">{{ $servicio->duracion }}</td> --}}
                                <td class="text-center py-3 px-4 border-b border-gray-600">${{ $servicio->precio }}</td>
                                @can('admin-actions')
